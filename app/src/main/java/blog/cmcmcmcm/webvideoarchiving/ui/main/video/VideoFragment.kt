...
import blog.cmcmcmcm.webvideoarchiving.data.database.repository.video.VideoWithTags
...
class VideoFragment : Fragment() {
    ...
    override fun onAttach(activity: Activity?) {
        Build.VERSION.SDK_INT.takeIf { it < Build.VERSION_CODES.M }
